    ...
    >
      <div className="max-w-7xl mx-auto text-center">
        ...
        <Motion.h2
          ...
          className="text-4xl md:text-5xl font-bold mb-10 bg-clip-text text-transparent bg-gradient-to-r from-yellow-200 to-orange-300"
        >
          My Projects
        </Motion.h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {projects.map((project, index) => (
            <Motion.div
              ...
              className="bg-gray-900/40 border border-white/10 rounded-2xl p-8 flex flex-col items-center text-center hover:bg-gray-900/55 transition"
            >
              {/* Icon */}
