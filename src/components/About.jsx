    ...
    >
      <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
        ...
        <div className="space-y-4 text-base md:text-lg text-slate-200 leading-relaxed">
          ...
          {isExpanded && (
            <>
              ...
              <p>
                I am particularly interested in emerging technologies such as artificial intelligence and web
                development, and I continuously strive to expand my knowledge by working on practical projects and
                exploring new tools. I am a quick learner, a collaborative team player, and someone who values clean,
                efficient, and scalable code.
              </p>
              <p>
                Currently, I am focused on enhancing my technical expertise while contributing to meaningful projects
                that solve real-life problems. My goal is to grow as a skilled engineer and create innovative solutions
        ...
        <button
          ...
          className="mt-6 inline-flex items-center text-sm md:text-base font-semibold text-indigo-300 transition hover:text-indigo-200"
        >
